...
async function fetchOrdersSince(token, sinceISO) {
  // Walmart Marketplace API calls authenticate with WM_SEC.ACCESS_TOKEN ONLY.
  // Do NOT also send an Authorization header — the gateway rejects it (403 FORBIDDEN.GMP_GATEWAY).
  const headers = {
